---
name: harness-forge
description: Generate AGENTS.md, CLAUDE.md, .cursor/rules, skills bundle and MCP config for the current project using Harness Forge. Use when the user says "set up this repo for Claude", "generate AGENTS.md", "scaffold my AI configs", "init claude code", or "make this work with cursor/codex/cline/windsurf".
---

# Harness Forge — Multi-Harness Config Generator
...
npx harness-forge init --yes --stack <stack-id> --harness <harness-id> [--harness <harness-id>...]

# Discover available choices
npx harness-forge list-stacks
npx harness-forge list-harnesses

# Preview without writing
npx harness-forge init --dry-run --yes
```
...
4. Run `npx harness-forge init --yes --stack <inferred> --harness claude-code [...]`.
...
- Web wizard: https://harness-forge.6x7.gr
- npm: https://www.npmjs.com/package/harness-forge
